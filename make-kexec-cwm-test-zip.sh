...
if [ ! -f ../../../out/target/product/epicmtd/obj/KERNEL_OBJ/Kernel/arch/arm/boot/zImage ]; then
  echo "ERROR: File not found: ../../../out/target/product/epicmtd/obj/KERNEL_OBJ/Kernel/arch/arm/boot/zImage"
  echo 
